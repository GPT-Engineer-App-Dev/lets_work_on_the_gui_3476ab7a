...
import { FaDownload, FaFileUpload, FaPrint, FaCog, FaPlus, FaMicrophone, FaRegKeyboard, FaFileWord, FaFilePdf, FaFileAlt, FaFileCsv } from "react-icons/fa";
        ...
        <Flex w="full" wrap="wrap" gap={10}>
          ...
          <Box w={{ base: "full", md: "65%" }} p={5} borderWidth="1px" borderRadius="lg">
            <VStack spacing={4}>
              ...
              <Textarea placeholder="Type your message here and press enter..." />
          ...
          <VStack w={{ base: "full", md: "35%" }} spacing={5}>
            ...
            <Button leftIcon={<FaFileUpload />} title="Click to upload a new avatar image">
              Upload New Avatar
            </Button>
            <HStack>
          ...
          <Box w="full" p={5} borderWidth="1px" borderRadius="lg">
            <VStack spacing={4}>
              ...
              <Menu>
                ...
                <MenuList>
                  <MenuItem icon={<FaFileWord />} onClick={() => handleDownloadChats("docx")}>
                    .docx
                  </MenuItem>
                  <MenuItem icon={<FaFilePdf />} onClick={() => handleDownloadChats("pdf")}>
                    .pdf
                  </MenuItem>
                  <MenuItem icon={<FaFileAlt />} onClick={() => handleDownloadChats("txt")}>
                    .txt
                  </MenuItem>
                  <MenuItem icon={<FaFileCsv />} onClick={() => handleDownloadChats("csv")}>
                    .csv
                  </MenuItem>
                </MenuList>
              </Menu>
          ...
          <Box w="full" p={5} borderWidth="1px" borderRadius="lg">
            <VStack spacing={4}>
              ...
              <Button leftIcon={<FaFileUpload />}>
                Upload Files
                <Text fontSize="sm">Select files to upload from your computer</Text>
              </Button>
              <Button leftIcon={<FaDownload />}>
                Download Files
                <Text fontSize="sm">Download selected files to your computer</Text>
              </Button>
            </VStack>
          </Box>
